package com.smg.mkframe.customviews;
...
import com.smg.mkframe.utils.AnimUtils;
...
//            view_bg.setBackgroundColor(ta.getColor(R.styleable.TitleBar_titleBgColor, getResources().getColor(R.color.colorPrimary)));
            ...
            btn_back.setImageResource(backStyle == ARROW ? R.mipmap.ic_back : android.R.drawable.ic_menu_close_clear_cancel);
